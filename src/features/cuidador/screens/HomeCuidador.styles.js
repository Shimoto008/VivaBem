...
/**
 * Estilos da área HomeCuidador — recebem `colors` (de `useTheme()`) em vez
...
export const getStyles = (colors) =>
  StyleSheet.create({
    ...
    secaoTitulo: { ...typography.title3, color: colors.textPrimary, marginTop: 15, marginBottom: 10 },
    ...
    txtAcaoCard: { fontSize: 11, fontWeight: 'bold', color: colors.textPrimary, marginTop: 5 },
    ...
    mesTitulo: { fontWeight: 'bold', color: colors.textPrimary, fontSize: 16 },
    ...
    diaTexto: { fontSize: 12, fontWeight: '500', color: colors.textPrimary },
    ...
    legendaInputTitulo: { fontSize: 13, fontWeight: 'bold', color: colors.textSecondary, marginBottom: 6, marginTop: 4 },
    ...
    tituloLinhaTempo: { fontSize: 14, fontWeight: 'bold', color: colors.textPrimary, marginBottom: 12 },
    ...
    txtConteudoLabel: { fontSize: 13, color: colors.textPrimary, lineHeight: 18 },
    ...
    nomeCuidador: { fontSize: 18, fontWeight: 'bold', color: colors.textPrimary },
    ...
    tituloSecaoPerfil: { fontSize: 14, fontWeight: 'bold', color: colors.textPrimary, marginLeft: 8 },
    conteudoTextoPerfil: { fontSize: 13, color: colors.textSecondary, lineHeight: 20, marginBottom: 4 },
    ...
    detalheExperiencia: { fontSize: 12, color: colors.textSecondary, lineHeight: 16 },
  });
