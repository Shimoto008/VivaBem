...
const getStyles = (colors, primaryColor) =>
  StyleSheet.create({
    ...
    calloutNome: { ...typography.title3, fontSize: 14, fontWeight: 'bold' },
    calloutEspecialidade: { ...typography.caption, fontSize: 11, color: '#666' },
    calloutAcao: { fontSize: 10, color: primaryColor, marginTop: 4, fontWeight: '600' },
    abaInferior: {
      position: 'absolute',
      bottom: 0,
      left: 0,
    ...
    infoCuidador: { flex: 1 },
    nomeCuidador: { ...typography.title3, fontSize: 15, color: colors.textPrimary },
    especialidadeCuidador: { ...typography.caption, color: colors.textSecondary },
    textoDetalhe: { ...typography.caption, fontSize: 12, color: colors.textSecondary, marginTop: 2 },
    botaoContato: {
